...
import 'package:app_login/model/studyclass.dart';
import 'package:app_login/repositories/student_repository.dart';
import 'package:app_login/repositories/studyclass_repository.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Text("Back to Home Page", style: AppConstant.textLink,))
            ],
          ),
        ),
      )),
